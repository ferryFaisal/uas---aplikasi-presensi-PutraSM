...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if($valName && $valEmail && $valPass && $valRole){
    require 'database.php';
    include "insert.php";
  }
}
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                          ...
                          <a class='btn btn-danger' href='delete_user.php?email=$row[email]' onClick=\"return confirm('Anda yakin akan menghapus record ini?')\">Delete</a></td>"
                          ?>
                      </tr>
                    <?php
                  }
    ...
    <div class="modal-content">
      ...
      <form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <div class="form-group">
              <p>Nama:<span class="error">*<?php echo $nameErr;?></span><br></p>
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="pass"></input>
              <br>
            </div>
            <div class="form-group">
              <p>Confirm Password:<span class="error">*<?php echo $repassErr;?></span></p>
              <input class="form-control" type="text" name="repass"></input>
              <br>
            </div>
            <div class="form-group">
